  ...
  <div class="container-fluid">
    <div class="table-container">
      <div class="table-container-title">
        <h1 class="table-title"><i class="fa-solid fa-user-cog"></i> Lista de Administradores</h1>
      </div>
      <div class="table-container-body">
        ...
        <div class="d-flex justify-content-between align-items-center search-container">
          ...
          <button class="btn btn-new-user" data-bs-toggle="modal" data-bs-target="#newAdmModal">
          ...
          <table id="clientTable" class="table table-striped">
            ...
            <tbody>
              <?php if (empty($resultData)) : ?>
                <tr>
                  <td colspan="9" class="text-center">Não há registros de administradores. <i class="fa-regular fa-face-sad-tear"></i></td>
                </tr>
              <?php else : ?>
